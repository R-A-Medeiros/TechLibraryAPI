...
public class DoLoginUseCaseTest
{
    ...
    public async Task Error_User_Not_Found()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains("Email or password invalid."));
    }
    ...
    private DoLoginUseCase CreatedUseCase(FCxLabs.TechLibraryAPI.Domain.Entities.User user, string? password = null)
    {
